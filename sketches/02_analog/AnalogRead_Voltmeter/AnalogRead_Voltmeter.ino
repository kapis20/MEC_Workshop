...
void setup()
{
  ...
  // This is done to initialise the serial communication and allow the potentiometer reading
...
void loop()
{
  ...
  //print out the potentiometer value:
  Serial.println("The sensor reading is:");
